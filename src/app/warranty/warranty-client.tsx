...
export function WarrantyClient({ items: _items }: { items: ItemData[] }) {
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title="Warranty"
        description="Manage warranty claims and repairs"
        actions={
      ...
      <div className="px-4 sm:px-6 lg:px-8 space-y-4">
        ...
        {_items.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="text-base font-semibold text-slate-900 mb-1">No warranty yet</h3>
            <p className="text-sm text-slate-500">Create your first warranty to get started.</p>
          </div>
        ) : (
